-- LibRover-1.0 inns (hearthstone destinations) for WoW 1.12.1.
--
-- Ported from ZygorGuidesViewerClassic's Libs-Classic/LibRover-1.0/data_inns.lua; the data itself is
