...
LibItemBonusLib_Locales.frFR = {
	...
	PATTERNS_PASSIVE = {
		...
		{ pattern = "Augmente vos chances d'infliger un coup critique avec vos sorts du Sacré de (%d+)%%%.", effect = "HOLYCRIT" },	-- set 202 | Improves your chance to get a critical strik
	},
	...
	PATTERNS_GENERIC_LOOKUP = {
		...
		["Coup critique"] = "CRIT",
		["point de dégâts"] = "DMG",
		["Appât de pêche"] = "FISHING",
		["Augmente les soins de"] = "HEAL",
		...
		["à la puissance d'attaque contre les morts-vivants"] = "ATTACKPOWERUNDEAD",
		["aux dégâts des sorts contre les morts-vivants"] = "DMGUNDEAD",
	},
